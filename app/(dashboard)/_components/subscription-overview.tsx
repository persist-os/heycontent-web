        ...
        <DialogContent>
          ...
          <div className="flex flex-col items-center gap-4 py-4">
            <div className="flex items-center gap-4">
              <Button size="icon" variant="outline" onClick={() => setPendingQuantity(Math.max(minQuantity, pendingQuantity - 1))} disabled={pendingQuantity <= minQuantity}>-</Button>
              <span className="text-2xl font-bold">{pendingQuantity * increment}</span>
              <Button size="icon" variant="outline" onClick={() => setPendingQuantity(pendingQuantity + 1)}>+</Button>
            </div>
