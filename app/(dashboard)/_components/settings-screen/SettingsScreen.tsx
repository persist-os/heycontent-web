...
import { LogOut, Users, Bell, Globe, Sliders, Database, Bug, CreditCard } from 'lucide-react'
      ...
      <div className="container max-w-6xl mx-auto py-4 sm:py-6 px-3 sm:px-6 space-y-4 sm:space-y-6">
        ...
        <Tabs defaultValue="account" className="space-y-4 sm:space-y-6">
          <TabsList className="w-full md:w-auto flex flex-nowrap px-3 sm:px-0">
            ...
            <TabsTrigger value="debug" className="flex-1 sm:flex-none"><Bug className="w-4 h-4 mr-2" /><span className="hidden sm:inline">Debug</span></TabsTrigger>
          </TabsList>
