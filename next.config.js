...
const securityHeaders = [
  {
    ...
    value: [
      ...
      "img-src * blob: data:;",
      "connect-src 'self' https://*.convex.cloud wss://*.convex.cloud https://js.stripe.com https://api.stripe.com https://identitytoolkit.googleapis.com https://securetoken.googleapis.com https://va.vercel-scripts.com https://backend.hicontent.co http://127.0.0.1:8000 http://localhost:8000 https://us-central1-content-454219.cloudfunctions.net https://storage.googleapis.com https://*.googleapis.com https://*.gstatic.com https://apis.google.com https://accounts.google.com;",
      "font-src 'self' data:;",
