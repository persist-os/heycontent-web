...
export const contentHubHelp: HelpPage[] = [
  ...
  },
  {
    ...
    description: "Jump between all your platforms with one click. Want just YouTube? Just Instagram? Easy."
  },
  {
...
// To update: Just tweak the text above. Keep it punchy and fun! 