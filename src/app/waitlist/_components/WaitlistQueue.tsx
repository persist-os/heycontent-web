    ...
    return (
      <div className="max-w-md mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-gray-700 mb-2">Get early access to creator tools</p>
          <p className="text-base text-gray-500">Join our exclusive beta testing program for creators</p>
        </div>
        ...
        <div className="bg-gradient-to-br from-white to-gray-50 rounded-2xl shadow-xl px-10 py-10 border border-gray-100 flex flex-col items-center w-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full mt-2">
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex flex-col items-center text-center max-w-xs mx-auto">
              ...
              <p className="text-gray-500 text-sm leading-relaxed">Keep this browser window open on your current device to maintain your beta access position.</p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex flex-col items-center text-center max-w-xs mx-auto">
              ...
              <p className="text-gray-500 text-sm leading-relaxed">Please don't open multiple tabs to avoid losing your spot in the beta queue.</p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex flex-col items-center text-center max-w-xs mx-auto">
              <Lock className="w-7 h-7 text-indigo-500 bg-indigo-50 rounded-full p-1 mb-3" />
              <h3 className="font-semibold text-gray-900 text-lg mb-2">Beta Detection Active</h3>
              <p className="text-gray-500 text-sm leading-relaxed">Our system is monitoring for automated access attempts to protect beta slots.</p>
            </div>
          </div>
        </div>
      </div>
    ...
    return (
      <div className="max-w-md mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-gray-700 mb-2">You're now part of our exclusive beta program!</p>
          <p className="text-base text-gray-500">Your early access credentials will be sent to your email.</p>
        </div>
        <CreatorCard
          name={name}
