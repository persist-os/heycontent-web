    ...
    <div className="max-w-none">
      ...
      <article className="space-y-12 text-gray-800 leading-relaxed">
        ...
        <section className="space-y-6">
          <h2 className="text-3xl font-medium text-gray-900 border-b border-gray-100 pb-3">
            Data Protection
          </h2>
        ...
        <section className="space-y-6 border-t border-gray-200 pt-12">
          <h2 className="text-3xl font-medium text-gray-900 border-b border-gray-100 pb-3">Cookie Policy</h2>
          <p>
          ...
          <h3 className="text-xl font-medium text-gray-900 mt-8">What are cookies?</h3>
          <p>
            Cookies are small data files that are placed on your computer or mobile device when you visit a website. Cookies are widely used by website owners in order to make their websites work, or to work more efficiently, as well as to provide reporting information.
          </p>
          <h3 className="text-xl font-medium text-gray-900 mt-8">What cookies do we use?</h3>
          <p>
          ...
          <div className="overflow-x-auto">
            <table className="min-w-[300px] mt-2 mb-6 border border-gray-200 text-sm">
              <thead>
                <tr className="bg-gray-50">
                  <th className="px-4 py-2 border-b border-gray-200 text-left font-semibold">Name</th>
                  <th className="px-4 py-2 border-b border-gray-200 text-left font-semibold">Provider</th>
                  <th className="px-4 py-2 border-b border-gray-200 text-left font-semibold">Type</th>
                  <th className="px-4 py-2 border-b border-gray-200 text-left font-semibold">Purpose</th>
                  <th className="px-4 py-2 border-b border-gray-200 text-left font-semibold">Expires in</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td className="px-4 py-2 border-b border-gray-100">firebase-auth-token</td>
                  <td className="px-4 py-2 border-b border-gray-100">www.heycontent.co</td>
                  <td className="px-4 py-2 border-b border-gray-100">First-party cookie</td>
                  <td className="px-4 py-2 border-b border-gray-100">Used to keep you signed in and authenticate your session securely.</td>
                  <td className="px-4 py-2 border-b border-gray-100">1 week or until logout</td>
                </tr>
              </tbody>
            </table>
          </div>
          <h3 className="text-xl font-medium text-gray-900 mt-8">What about localStorage?</h3>
          <p>
          ...
          <div className="overflow-x-auto">
            <table className="min-w-[300px] mt-2 mb-6 border border-gray-200 text-sm">
              <thead>
                <tr className="bg-gray-50">
                  <th className="px-4 py-2 border-b border-gray-200 text-left font-semibold">Key</th>
                  <th className="px-4 py-2 border-b border-gray-200 text-left font-semibold">Type</th>
                  <th className="px-4 py-2 border-b border-gray-200 text-left font-semibold">Purpose</th>
                  <th className="px-4 py-2 border-b border-gray-200 text-left font-semibold">Expires in</th>
                </tr>
              ...
              <tbody>
                <tr>
                  <td className="px-4 py-2 border-b border-gray-100">heycontent-sidebar-state</td>
                  <td className="px-4 py-2 border-b border-gray-100">localStorage</td>
                  <td className="px-4 py-2 border-b border-gray-100">Remembers if your sidebar is open or closed.</td>
                  <td className="px-4 py-2 border-b border-gray-100">Persistent (until you clear your browser storage)</td>
                </tr>
              </tbody>
            </table>
          </div>
          <h3 className="text-xl font-medium text-gray-900 mt-8">How can I control cookies?</h3>
          <p>
          ...
          <h3 className="text-xl font-medium text-gray-900 mt-8">Other tracking technologies</h3>
          <p>
