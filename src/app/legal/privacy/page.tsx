      ...
      <article className="space-y-12 text-foreground leading-relaxed">
        ...
        <section className="space-y-6">
          ...
          <ul className="space-y-2 ml-6">
            ...
            <li><strong>Website</strong>: HeyContext, accessible from <a href="https://www.heycontext.ai/" className="text-blue-600 dark:text-blue-400 hover:underline" target="_blank" rel="noopener noreferrer">https://www.heycontext.ai/</a></li>
