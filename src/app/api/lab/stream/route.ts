...
export async function POST(request: Request) {
  ...
  console.log(`[${requestId}] Lab stream request started`, {
  ...
  try {
    ...
    // Transform thinking lab payload to streaming chat API format
    const {
      user_id,
      query,
      is_first_message,
    ...
    console.log(`[${requestId}] Received streaming lab request:`, {
      user_id: userId,
    ...
    console.error(`[${requestId}] Lab stream request failed`, {
