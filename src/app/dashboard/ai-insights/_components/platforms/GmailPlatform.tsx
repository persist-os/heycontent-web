...
import { RefreshCw, AlertCircle, Settings, Zap, Mail } from 'lucide-react'
...
export function GmailPlatform({ userId, currentQuote }: GmailPlatformProps) {
  ...
  // Tab-specific refresh controls component with thread limit selector
        ...
        <div className="flex flex-col lg:flex-row lg:justify-between lg:items-start gap-6">
          ...
          <div className="flex-1 max-w-xl">
            ...
            <div className="flex items-center justify-between mb-2">
              <button
                onClick={() => setShowGmailCustomInput(!showGmailCustomInput)}
                disabled={isRefreshing}
              ...
              <div className="flex items-center gap-1.5 px-2 py-1 bg-gray-50 dark:bg-gray-800 rounded text-xs">
                ...
                <span className="font-medium text-gray-900 dark:text-white">
                  {threadLimit === 'all' ? 'All items' : `${threadLimit} items`}
                </span>
              </div>
            </div>
              ...
              <div className="p-3 bg-gray-50 dark:bg-gray-800/50 rounded-lg border border-gray-200 dark:border-gray-700">
                <div className="flex items-center gap-2">
                  <input
                    ...
                    min="1"
                    max="1000"
                    value={customGmailLimit}
                    onChange={(e) => setCustomGmailLimit(e.target.value)}
                  ...
                  <button
                    ...
                    disabled={!customGmailLimit || isRefreshing || parseInt(customGmailLimit) < 1 || parseInt(customGmailLimit) > 1000}
