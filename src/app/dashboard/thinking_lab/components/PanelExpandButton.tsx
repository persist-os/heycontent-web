...
export function PanelExpandButton({
  ...
  const isFullScreen = 
    (panelType === 'dialogue' && panelState === 'dialogue-full') ||
    (panelType === 'reflection' && panelState === 'reflection-full')
  ...
  const getTooltipText = () => {
    ...
    const shortcut = shortcutMap[panelType]
