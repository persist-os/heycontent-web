      ...
      >
        ...
        {mediaUrl ? (
          ...
          <div className="relative aspect-square bg-muted flex items-center justify-center">
            {getSectionConfig('instagramPost').icon({ className: "w-12 h-12 text-pink-400" })}
      ...
      >
        ...
        {thumbnailUrl ? (
          ...
          <div className="relative aspect-video bg-muted flex items-center justify-center">
            {getSectionConfig('youtubeVideo').icon({ className: "w-12 h-12 text-red-400" })}
            <div className="absolute bottom-2 right-2 bg-black/80 text-white text-xs px-2 py-1 rounded">
              No Thumbnail
            </div>
          </div>
                      ...
                      >
                        ...
                        <div className="relative bg-muted/30 p-3 border-b border-border">
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2">
                              {getSectionConfig('analysis').icon({ className: "w-5 h-5 text-indigo-500" })}
                        ...
                        <div className="p-4">
                          ...
                          <div className="flex items-center gap-2 text-sm text-muted-foreground mb-2">
                            {getSectionConfig('analysis').icon({ className: "w-3 h-3" })}
