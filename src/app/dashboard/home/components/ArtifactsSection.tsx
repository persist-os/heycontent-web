    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <h2 className="text-lg font-medium text-foreground"><T context="dashboard.home.artifacts.title">Recent Artifacts</T></h2>
        </div>
    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          ...
          >
            <T context="dashboard.home.artifacts.see_all">See all</T>
            <ArrowRight className="w-4 h-4" />
          </Link>
        </div>
        <div className="text-center py-16 border border-dashed border-border rounded-2xl bg-muted/20">
          <p className="text-muted-foreground"><T context="dashboard.home.artifacts.empty">No artifacts yet. Create a project and generate some widgets!</T></p>
        </div>
      </div>
    )
  }
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <h2 className="text-lg font-medium text-foreground">
          <T context="dashboard.home.artifacts.title">Recent Artifacts</T>
        </h2>
        <Link 
          href="/dashboard/living-projects"
          className="flex items-center gap-2 text-sm text-primary hover:text-primary-dark transition-colors font-medium hover:underline"
