        ...
        {messages.map((message, index) => {
          ...
          return (
            <div key={message.id} className="space-y-1">
              {/* Message Header */}
              <div 
                className={`flex items-center justify-between p-3 rounded-lg border cursor-pointer transition-colors hover:bg-muted/30 ${getMessageBackground(message, isSelected)}`}
                onClick={() => {
              ...
              {isExpanded && (
                <div className="ml-6 p-4 bg-muted/20 rounded-lg border border-border">
