 ...
 * The star maintains a constant on-screen size regardless of zoom using inverse scaling.
 */
export function WidgetStar({ widget, x, y, scale, onClick, onHover }: WidgetStarProps) {
