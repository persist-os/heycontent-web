...
/**
 * AssignmentCard - Matches Figma design exactly
 * 
 * Figma specs:
 * - Width: 1124px, Height: 168px
 * - Border: 2px solid rgba(101,181,255,0.75) with gradient background (active) OR #313030 background with #313030 border (inactive)
 * - Border radius: 12px
  ...
  return (
    <a
      ...
      className={cn(
        ...
        isActive
          ? 'bg-gradient-to-r border-2 border-[rgba(101,181,255,0.75)] border-solid from-[rgba(101,181,255,0)] to-[rgba(255,163,18,0.5)]'
          : 'bg-[hsl(var(--notes-surface-dim))] border-2 border-[hsl(var(--notes-surface-dim))] border-solid',
        className
      )}
    >
      <div className="box-border content-stretch flex flex-col gap-[8px] items-end overflow-clip px-[36px] py-[8px] relative rounded-[inherit] w-full">
        ...
        <div className="content-stretch flex font-['DM_Sans'] font-semibold gap-[10px] h-[36px] items-center justify-center leading-[0] relative shrink-0 w-[1051px]">
          <div className={cn(
            ...
            isActive ? 'text-[hsl(var(--assignment-text-regular))]' : 'text-[hsl(var(--assignment-text-subtle))]'
          )}>
        ...
        <div className="content-stretch flex h-[32px] items-center relative shrink-0 w-[1051px]">
          <div className="content-stretch flex gap-[20px] items-center relative shrink-0">
            {path && (
              <div className="flex flex-col font-['DM_Sans'] font-semibold justify-center leading-[0] relative shrink-0 text-[0px] text-[hsl(var(--assignment-primary-blue))] tracking-[-0.48px] whitespace-nowrap [font-variation-settings:\'opsz\'_14]">
                <p className="font-['DM_Sans'] font-semibold leading-[24px] text-[16px]">{path}</p>
              </div>
            )}
            {tag && (
              <div className="bg-[hsl(var(--assignment-primary-container))] box-border content-stretch flex gap-[10px] items-center justify-center px-[8px] py-[4px] relative rounded-[8px] shrink-0">
                <div className="flex flex-col font-['DM_Sans'] font-semibold justify-center leading-[0] relative shrink-0 text-[hsl(var(--assignment-text-regular))] text-[16px] tracking-[-0.48px] whitespace-nowrap [font-variation-settings:\'opsz\'_14]">
