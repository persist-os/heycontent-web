...
export function GalleryNavigation({
  ...
  return (
    <nav className="flex items-center justify-between gap-4" aria-label="Gallery navigation">
      {/* Previous Button */}
      <Button
        onClick={onPrev}
        disabled={!hasPrev}
        ...
        variant="ghost"
        aria-label={`Go to previous item, ${currentIndex} of ${total}`}
      >
      ...
      >
        ...
        <span className="text-sm text-muted-foreground mx-1.5" aria-hidden="true">/</span>
      ...
      <Button
        ...
        variant="ghost"
        aria-label={`Go to next item, ${currentIndex + 2} of ${total}`}
      >
