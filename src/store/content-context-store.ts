    ...
    subscribeWithSelector((set, get) => ({
      ...
      setInstagramContext: (instagramPost: Doc<'instagramPosts'>) => {
        const context = {
          ...
          title: instagramPost.caption || 'Instagram Post',
          analysis: instagramPost.analysisMarkdown || instagramPost.analysis?.summary || null,
          thumbnailUrl: instagramPost.media?.[0]?.mediaUrl || instagramPost.media?.[0]?.thumbnailUrl,
          publishedAt: instagramPost.timestamp || new Date(instagramPost.createdAt || Date.now()).toISOString(),
          metrics: instagramPost.insights || {
            likes: 0,
            comments: 0,
            shares: 0,
            saves: 0,
          ...
          content: {
            ...
            insights: instagramPost.insights,
            children: instagramPost.children,
            comments: instagramPost.comments,
      ...
      setYouTubeContext: (youtubeVideo: Doc<'youtubeVideos'>) => {
        const context = {
          ...
          content: {
            ...
            channelTitle: youtubeVideo.snippet?.channel_title,
